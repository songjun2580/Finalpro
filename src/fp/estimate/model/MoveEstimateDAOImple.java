...
public class MoveEstimateDAOImple implements MoveEstimateDAO {
	...
	public MoveContractDTO contract(int mbIdx) {
		MoveContractDTO dto=sst.selectOne("finalContract",mbIdx);
		return dto;
	}
	
	public int zeroSet(MoveContractWriteDTO dto) {
		int count=sst.insert("zeroSet",dto);
		return count;
	}
	public int contractWrite(MoveContractWriteDTO dto) {
		int result=sst.insert("confirmWriteMoveest",dto);
		return result;
	}
	
	public MoveContractWriteDTO getContract(int mbIdx) {
		MoveContractWriteDTO dto=sst.selectOne("getContract",mbIdx);
		return dto;

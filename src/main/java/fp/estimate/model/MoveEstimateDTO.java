...
public MoveEstimateDTO(int moIdx, int uIdx, String moDate, String moName, String moTel, String moConsult,
		String moFamily, String szipNo, String moSaddr, int moSfloor, String moZim, String moType, int moSize,
		String ezipNo, String moEaddr, int moEfloor, String moService1, String moService2, String moStatus, int empIdx,
		int coIdx, int motempPrice, int moconfrimPrice, String empName) {
	super();
	this.moIdx = moIdx;
	this.uIdx = uIdx;
	this.moDate = moDate;
	...
	this.moconfrimPrice = moconfrimPrice;
...
public int getMoconfrimPrice() {
	return moconfrimPrice;
}

public void setMoconfrimPrice(int moconfrimPrice) {
	this.moconfrimPrice = moconfrimPrice;
}

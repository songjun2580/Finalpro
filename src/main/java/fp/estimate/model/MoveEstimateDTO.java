...
public class MoveEstimateDTO {
	...
	public MoveEstimateDTO(int moIdx, int uIdx, String moDate, String moName, String moTel, String moConsult, String szipNo,
			String moSaddr, int moSfloor, String moType, int moSize, String ezipNo, String moEaddr, int moEfloor,
			String moService1, String moService2, String moStatus) {
		super();
		this.moIdx = moIdx;
		this.uIdx = uIdx;
		this.moDate = moDate;

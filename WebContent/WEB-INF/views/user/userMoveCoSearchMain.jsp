...
<%@include file="../header.jsp" %>
   ...
   <div class="search">
      <img src="<%=request.getContextPath()%>/resources/img/logo.jpg" style="width:500px; heigth:500px;"><br>
      <form name="moSearchEngine" action="moSearchEngine.do">
         <div class="search_engine">
            <input type="text" name="mo_search" placeholder="지역  또는 업체명을 검색" required style="width:500px;">&nbsp;&nbsp;<input type="submit" value="검색하기 ">
         </div>
      </form>
   </div>

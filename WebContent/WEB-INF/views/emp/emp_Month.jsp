   ...
   <header class="masthead"  style="background-image: url('resources/img/emp_main.png');">
    ...
    <div class="col-2">
	    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
	      <a class="nav-link active" id="v-pills-home-tab"  href="emp_Month.do" role="tab" aria-controls="v-pills-home" aria-selected="ture">전체 실적</a>
                      ...
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col">
                          <div class="progress progress-sm mr-2">
                            <div class="progress-bar bg-info" role="progressbar" style="width: ${counting*10}%" aria-valuenow="5" aria-valuemin="0" aria-valuemax="10"></div>
                          </div>
                        </div>
                      </div>
                    </div>

...
<div class="row">
  <div class="col-2">
    ...
    <a class="nav-link" id="v-pills-profile-tab"  href="admCest.do" role="tab" aria-controls="v-pills-profile">전체 신청목록</a>
    <a class="nav-link" id="v-pills-profile-tab"  href="admCest_wait.do" role="tab" aria-controls="v-pills-profile">승인대기</a>
    <a class="nav-link active" id="v-pills-home-tab"  href="admCest_confirm.do" role="tab" aria-controls="v-pills-home">승인완료</a>
    </div>
  </div>
  <div class="col-9">
